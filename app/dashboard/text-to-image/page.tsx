...
const TextToImageClient = dynamic(
  () => import("../../../components/text-to-image"),
  {
    ssr: true,
    loading: () => (
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <p className="text-muted-foreground mb-8 text-base text-center md:text-left">
        Type any prompt and generate stunning AI images instantly. Choose styles
        like realistic, anime, or abstract — all for free!
      </p>
